...
from _anomaly_detection import AnomalyDetection_RPCA
import pandas as pd
from csvdata import points_to_csv
...
def process_temperature_values(value_values, time_values, measurement, time_interval, influxdb_client):
    ...
    csv_data = points_to_csv(outliers, time_values,
                             measurement, time_interval, influxdb_client, 'output.csv')
...
# Plot the smooth component (if needed)
# plt.plot(S, label='Smooth')
"""
